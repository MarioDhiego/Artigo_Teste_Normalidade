...
%%%%%%%%%% Erro Tipo I -> Distribuição Gamma %%%%%%%%%%
\begin{figure}[H]
    \centering
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Erro Tipo I/erro_tipo_I_gamma_30.pdf}
        \caption{Tamanho amostral \(n = 30\)}
        \label{fig:gamma_30}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Erro Tipo I/erro_tipo_I_gamma_50.pdf}
        \caption{Tamanho amostral \(n = 50\)}
        \label{fig:gamma_50}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Erro Tipo I/erro_tipo_I_gamma_100.pdf}
        \caption{Tamanho amostral \(n = 100\)}
        \label{fig:gamma_100}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Erro Tipo I/erro_tipo_I_gamma_300.pdf}
        \caption{Tamanho amostral \(n = 300\)}
        \label{fig:gamma_300}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Erro Tipo I/erro_tipo_I_gamma_500.pdf}
        \caption{Tamanho amostral \(n = 500\)}
        \label{fig:gamma_500}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Erro Tipo I/erro_tipo_I_gamma_1000.pdf}
        \caption{Tamanho amostral \(n = 1000\)}
        \label{fig:gamma_1000}
    \end{subfigure}
\end{figure}

%%%%%%%%%% Poder do Teste -> Distribuição Gamma %%%%%%%%%%
\begin{figure}[H]
    \centering
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Poder do Teste/poder_teste_gamma_30.pdf}
        \caption{Tamanho amostral \(n = 30\)}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Poder do Teste/poder_teste_gamma_50.pdf}
        \caption{Tamanho amostral \(n = 50\)}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Poder do Teste/poder_teste_gamma_100.pdf}
        \caption{Tamanho amostral \(n = 100\)}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Poder do Teste/poder_teste_gamma_300.pdf}
        \caption{Tamanho amostral \(n = 300\)}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Poder do Teste/poder_teste_gamma_500.pdf}
        \caption{Tamanho amostral \(n = 500\)}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Distribuição Beta/Poder do Teste/poder_teste_gamma_1000.pdf}
        \caption{Tamanho amostral \(n = 1000\)}
